try:
    ...
    import os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,getpass,mechanize,requests,Monir
...
--------------------------------------------------
 ...
 GitHub   : https://github.com/MonirHosen69

 Fb Page :  facebook.com/MONIRHOSEN0
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/MONIRHOSEN0')
